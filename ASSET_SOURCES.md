...
| Website asset | Project material source |
| --- | --- |
| `assets/pipeline/execution-optimization-horizontal.svg` | Horizontal web reflow of `materials/sub_pic/ego_pipeline/world_frame_hand_motion/v1/images/07_execution_optimization_v2.svg`; generated by `tools/render_execution_optimization_horizontal.py` |
